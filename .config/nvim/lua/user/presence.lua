local function config()
  ...
  require("presence"):setup({
    ...
    editing_text = const("Editing files"), -- Format string rendered when an editable file is loaded in the buffer (either string or function(filename: string): string)
