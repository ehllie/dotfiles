...
git clone "--separate-git-dir=${XDG_CONFIG_HOME:-$HOME/.config}/dotfile-gitdir" "git@github.com:ehllie/my-dotfiles.git" "${XDG_CACHE_HOME:-$HOME/.cache}/dotfile-gitdir"
rm -r "${XDG_CACHE_HOME:-$HOME/.cache}/dotfiles"
